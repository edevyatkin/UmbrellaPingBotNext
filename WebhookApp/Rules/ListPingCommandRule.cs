...
namespace WebhookApp.Rules
{
    internal class ListPingCommandRule : IUpdateRule
    {
        ...
        public ListPingCommandRule(ITelegramBotClient botService, MessageRule messageRule, BotConfig botConfig, ILogger<ListPingCommandRule> logger, IBattleService battleService) {
